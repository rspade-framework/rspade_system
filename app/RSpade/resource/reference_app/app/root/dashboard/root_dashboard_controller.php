...
namespace Rsx\App\Root\Dashboard;
...
class Root_Dashboard_Controller extends Rsx_Controller_Abstract
{
    /**
     * Handle index page for root dashboard
     *
    ...
    public static function index(Request $request, array $params = [])
    {
        ...
        return rsx_view('Root_Dashboard', $data);
    }
}

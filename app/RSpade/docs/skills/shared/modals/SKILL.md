...
`system/app/RSpade/resource/reference_app/app/frontend/settings/api_keys/add_api_key_modal_form.jqhtml`
...
- Skill `rspade:forms` - the form contract a modal hosts
- `system/app/RSpade/resource/reference_app/lib/modal/CLAUDE.md` - the template app's own notes

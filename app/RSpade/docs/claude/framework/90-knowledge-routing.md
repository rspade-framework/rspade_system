...
- **Man page** (`../man/*.txt`) = the contract/spec, the source of truth. A skill that grows contract tables pushes them here. Keeping it true to what the framework actually does is part of the change that moved the behavior — `82-documentation-obligations.md` owns that rule.

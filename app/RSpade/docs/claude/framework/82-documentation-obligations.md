...
Skill `rspade:shipping-a-contract-change` (working the mandate, audit routing, authoring a breaking_changes doc or checklist entry). Details: `rsx:ma breaking_changes`.

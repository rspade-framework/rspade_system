...
/**
 * Revision_Model_Abstract - one row per recorded write to a revisioned record.
 *
 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Revision_Model lives here;
 * `Revision_Model.php` beside it is a shell an application replaces by declaring
 * `class Revision_Model extends Revision_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Revision_Model_Abstract extends Rsx_Model_Abstract
{
    /**

...
use App\RSpade\Core\Revisions\Revision_Model_Abstract;
 ...
 * Revision_Model_Abstract (`Revision_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Revision_Model extends Revision_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Revision_Model.php.upstream, your class becomes
 * Revision_Model for the whole tree, and it keeps inheriting everything the framework

 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Zip_Download_Request_Model lives here;
 * `Zip_Download_Request_Model.php` beside it is a shell an application replaces by declaring
 * `class Zip_Download_Request_Model extends Zip_Download_Request_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Zip_Download_Request_Model_Abstract extends Rsx_System_Model_Abstract
{
    /**

...
/**
 * Two_Factor_Credential_Model_Abstract - one second factor belonging to one login identity.
 *
 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Two_Factor_Credential_Model lives here;
 * `Two_Factor_Credential_Model.php` beside it is a shell an application replaces by declaring
 * `class Two_Factor_Credential_Model extends Two_Factor_Credential_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Two_Factor_Credential_Model_Abstract extends Rsx_System_Model_Abstract
{
    /**

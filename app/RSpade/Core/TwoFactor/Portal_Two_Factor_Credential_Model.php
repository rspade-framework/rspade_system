...
use App\RSpade\Core\TwoFactor\Portal_Two_Factor_Credential_Model_Abstract;

/**
 * Portal_Two_Factor_Credential_Model - one second factor or passkey belonging to one portal user.
 *
 * THIS FILE IS A SHELL, AND THAT IS ITS ENTIRE JOB. Every member lives on
 * Portal_Two_Factor_Credential_Model_Abstract (`Portal_Two_Factor_Credential_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Portal_Two_Factor_Credential_Model extends Portal_Two_Factor_Credential_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Portal_Two_Factor_Credential_Model.php.upstream, your class becomes
 * Portal_Two_Factor_Credential_Model for the whole tree, and it keeps inheriting everything the framework

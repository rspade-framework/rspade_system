...
/**
 * Api_Request_Log_Model_Abstract - one row per external API request (_api_request_log).
 *
 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Api_Request_Log_Model lives here;
 * `Api_Request_Log_Model.php` beside it is a shell an application replaces by declaring
 * `class Api_Request_Log_Model extends Api_Request_Log_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Api_Request_Log_Model_Abstract extends Rsx_System_Model_Abstract
{
    /**

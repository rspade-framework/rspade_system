...
use App\RSpade\Core\Search\Search_Index_Model_Abstract;
 ...
 * Search_Index_Model_Abstract (`Search_Index_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Search_Index_Model extends Search_Index_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Search_Index_Model.php.upstream, your class becomes
 * Search_Index_Model for the whole tree, and it keeps inheriting everything the framework

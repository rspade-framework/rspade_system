...
/**
 * Search_Index_Model_Abstract - the extracted-text store behind document full-text search.
 *
 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Search_Index_Model lives here;
 * `Search_Index_Model.php` beside it is a shell an application replaces by declaring
 * `class Search_Index_Model extends Search_Index_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Search_Index_Model_Abstract extends Rsx_Model_Abstract
{
    /**

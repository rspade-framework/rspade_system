 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Email_Attachment_Model lives here;
 * `Email_Attachment_Model.php` beside it is a shell an application replaces by declaring
 * `class Email_Attachment_Model extends Email_Attachment_Model_Abstract` under rsx/models/ - so an

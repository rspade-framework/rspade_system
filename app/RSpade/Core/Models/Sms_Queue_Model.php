...
use App\RSpade\Core\Models\Sms_Queue_Model_Abstract;
 ...
 * Sms_Queue_Model_Abstract (`Sms_Queue_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Sms_Queue_Model extends Sms_Queue_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Sms_Queue_Model.php.upstream, your class becomes
 * Sms_Queue_Model for the whole tree, and it keeps inheriting everything the framework

...
use App\RSpade\Core\Models\Email_Recipient_Model_Abstract;
 ...
 * Email_Recipient_Model_Abstract (`Email_Recipient_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Email_Recipient_Model extends Email_Recipient_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Email_Recipient_Model.php.upstream, your class becomes
 * Email_Recipient_Model for the whole tree, and it keeps inheriting everything the framework

...
/**
 * Email_Queue_Model_Abstract - Database-backed email queue (framework core).
 *
 ...
 *
 * This is CORE infrastructure the Rsx_Mail facade hard-depends on; an app that needs to
 * customize it declares `class Email_Queue_Model extends Email_Queue_Model_Abstract` in
 * rsx/models/email_queue_model.php, carrying only the members it changes.
 *
 * @property integer $id
 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Email_Queue_Model lives here;
 * `Email_Queue_Model.php` beside it is a shell an application replaces by declaring
 * `class Email_Queue_Model extends Email_Queue_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Email_Queue_Model_Abstract extends Rsx_Site_Model_Abstract
{
    /**

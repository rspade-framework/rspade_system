 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Ip_Address_Model lives here;
 * `Ip_Address_Model.php` beside it is a shell an application replaces by declaring
 * `class Ip_Address_Model extends Ip_Address_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Ip_Address_Model_Abstract extends Rsx_System_Model_Abstract
{
    /**

...
use App\RSpade\Core\Models\User_Verification_Model_Abstract;

/**
 * User_Verification_Model - an email/SMS verification code for confirmation, recovery or a second factor.
 *
 * THIS FILE IS A SHELL, AND THAT IS ITS ENTIRE JOB. Every member lives on
 * User_Verification_Model_Abstract (`User_Verification_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class User_Verification_Model extends User_Verification_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as User_Verification_Model.php.upstream, your class becomes
 * User_Verification_Model for the whole tree, and it keeps inheriting everything the framework

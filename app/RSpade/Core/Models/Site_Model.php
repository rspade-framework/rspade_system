...
use App\RSpade\Core\Models\Site_Model_Abstract;

/**
 * Site_Model - one workspace/organization, the primary tenant boundary.
 *
 * THIS FILE IS A SHELL, AND THAT IS ITS ENTIRE JOB. Every member lives on
 * Site_Model_Abstract (`Site_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Site_Model extends Site_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Site_Model.php.upstream, your class becomes
 * Site_Model for the whole tree, and it keeps inheriting everything the framework

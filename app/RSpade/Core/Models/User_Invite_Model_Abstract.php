 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's User_Invite_Model lives here;
 * `User_Invite_Model.php` beside it is a shell an application replaces by declaring
 * `class User_Invite_Model extends User_Invite_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class User_Invite_Model_Abstract extends Rsx_Site_Model_Abstract
{
    /**

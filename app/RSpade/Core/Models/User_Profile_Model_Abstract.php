 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's User_Profile_Model lives here;
 * `User_Profile_Model.php` beside it is a shell an application replaces by declaring
 * `class User_Profile_Model extends User_Profile_Model_Abstract` under rsx/models/ - so an

...
/**
 * Portal_Notification_Model_Abstract - the framework-core portal activity / notification
 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Portal_Notification_Model lives here;
 * `Portal_Notification_Model.php` beside it is a shell an application replaces by declaring
 * `class Portal_Notification_Model extends Portal_Notification_Model_Abstract` under rsx/models/ - so an
 ...
 */
#[Auth('is_logged_in')]
abstract class Portal_Notification_Model_Abstract extends Rsx_Site_Model_Abstract
{

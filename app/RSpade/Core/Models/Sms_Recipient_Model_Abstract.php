...
/**
 * Sms_Recipient_Model_Abstract - Per-number SMS blocklist + delivery stats (core).
 *
 ...
 * Rsx_Sms blocklist API depends on. An app customizes it by declaring
 * `class Sms_Recipient_Model extends Sms_Recipient_Model_Abstract` in rsx/models/,
 ...
 * @mixin \Eloquent
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Sms_Recipient_Model lives here;
 * `Sms_Recipient_Model.php` beside it is a shell an application replaces by declaring
 * `class Sms_Recipient_Model extends Sms_Recipient_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Sms_Recipient_Model_Abstract extends Rsx_Site_Model_Abstract
{

...
use App\RSpade\Core\Models\Login_User_Model_Abstract;
 ...
 * Login_User_Model_Abstract (`Login_User_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Login_User_Model extends Login_User_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Login_User_Model.php.upstream, your class becomes
 * Login_User_Model for the whole tree, and it keeps inheriting everything the framework

...
use App\RSpade\Core\Models\Email_Attachment_Model_Abstract;
 ...
 * Email_Attachment_Model_Abstract (`Email_Attachment_Model_Abstract.php`, beside this file); this class exists
 ...
 *
 *     class Email_Attachment_Model extends Email_Attachment_Model_Abstract
 *     {
 *         // only the members you change
 *     }
 *
 * The manifest archives this file as Email_Attachment_Model.php.upstream, your class becomes
 * Email_Attachment_Model for the whole tree, and it keeps inheriting everything the framework

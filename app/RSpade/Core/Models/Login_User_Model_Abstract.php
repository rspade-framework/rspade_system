 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Login_User_Model lives here;
 * `Login_User_Model.php` beside it is a shell an application replaces by declaring
 * `class Login_User_Model extends Login_User_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Login_User_Model_Abstract extends Rsx_Actor_Model_Abstract implements
    ...
    \Illuminate\Contracts\Auth\CanResetPassword
{
     ...
     *
     * An application that builds a cross-site identity admin declares
     * `class Login_User_Model extends Login_User_Model_Abstract` in rsx/models/ and
     * returns its own route. The method is #[Replaceable], so no parent:: call.
     *
     * @return string|null
     */
    #[Replaceable]

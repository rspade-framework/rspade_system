 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's User_Verification_Model lives here;
 * `User_Verification_Model.php` beside it is a shell an application replaces by declaring
 * `class User_Verification_Model extends User_Verification_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class User_Verification_Model_Abstract extends Rsx_Model_Abstract
{
    /**

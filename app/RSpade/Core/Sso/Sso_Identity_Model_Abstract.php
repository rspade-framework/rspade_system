...
/**
 * Sso_Identity_Model_Abstract - one connection between a login identity and one account at one
 * identity provider.
 *
 ...
 *
 * THE BASE OF A SPLIT MODEL. Every member of the framework's Sso_Identity_Model lives here;
 * `Sso_Identity_Model.php` beside it is a shell an application replaces by declaring
 * `class Sso_Identity_Model extends Sso_Identity_Model_Abstract` under rsx/models/ - so an
 ...
 * @mixin \Eloquent
 */
abstract class Sso_Identity_Model_Abstract extends Rsx_System_Model_Abstract
{
    /**

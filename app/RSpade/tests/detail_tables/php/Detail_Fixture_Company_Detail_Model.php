...
/**
 * Test fixture: the COMPANY detail for Detail_Fixture_Party_Model. Tables are created at
 * runtime by the detail_tables tests (not a shipped migration).
 */
class Detail_Fixture_Company_Detail_Model extends Rsx_Detail_Model_Abstract
{
    protected $table = 'detail_fixture_company_details';
    protected $fillable = [];

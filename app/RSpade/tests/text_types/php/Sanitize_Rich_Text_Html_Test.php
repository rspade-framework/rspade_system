...
/**
 * sanitize_rich_text_html() keeps a Quill 2 checklist's state and nothing else it did not already allow.
 *
 ...
 */
class Sanitize_Rich_Text_Html_Test extends Rsx_Test_Abstract
{
    ...
    public static function test_a_checklist_keeps_its_state()
    {
        static::__assert_equals(
            ...
            sanitize_rich_text_html('<ul><li data-list="checked">done</li><li data-list="unchecked">todo</li></ul>'),
    ...
    public static function test_the_ordinary_list_kinds_survive_too()
    {
        static::__assert_equals(
            ...
            sanitize_rich_text_html('<ol><li data-list="ordered">a</li><li data-list="bullet">b</li></ol>'),
    ...
    public static function test_the_editor_ui_is_dropped_and_the_state_kept()
    {
        static::__assert_equals(
            ...
            sanitize_rich_text_html('<ol><li data-list="checked"><span class="ql-ui" contenteditable="false"></span>x</li></ol>'),
    ...
    {
        static::__assert_equals('<ul><li>x</li></ul>', sanitize_rich_text_html('<ul><li data-list="javascript:1">x</li></ul>'));
    }

    public static function test_data_list_off_an_li_is_dropped()
    {
        static::__assert_equals('<p>x</p>', sanitize_rich_text_html('<p data-list="checked">x</p>'));
    }

    public static function test_other_data_attributes_are_still_dropped()
    {
        static::__assert_equals('<ul><li>x</li></ul>', sanitize_rich_text_html('<ul><li data-foo="1" onclick="x()">x</li></ul>'));
    }
}

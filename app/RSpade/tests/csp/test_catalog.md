...
| CSP-19b | An anonymous POST can append only a bounded number of lines | http | a 70 KB body; a 60-entry Reporting API batch | 204 each; one `oversized` line naming the size; 50 lines plus one `dropped:10` line | implemented | 2026-09-25 |

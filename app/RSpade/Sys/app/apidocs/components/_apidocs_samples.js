 ...
 *                   (_Apidocs_Tester.current_values), so the two can never disagree.
 *
 ...
 * _apidocs_escaping.js. This matters most in filled mode, where the values are whatever a
 ...
 *
 * Called from api_code_samples() above when _Apidocs_Catalog.file_param() names a part.
 ...
 * and copy buttons in _Apidocs_Code_Samples need to know nothing about which generator ran.
 */
 ...
 * It defaults to _Apidocs_Tester, the original and still the common caller.
 */

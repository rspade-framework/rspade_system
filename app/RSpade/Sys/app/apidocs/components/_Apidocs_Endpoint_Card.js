/**
 * _Apidocs_Endpoint_Card - one endpoint: verb pills + pattern, description, params table,
 ...
 */
class _Apidocs_Endpoint_Card extends Component {
    /**
    ...
    on_create() {
        ...
        this.args.example_open = window.innerWidth >= _Apidocs_Endpoint_Card.WIDE_AT;
    }

...
class Framework_Verify_Command extends Command
{
    ...
    public function handle(): int
    {
        ...
        // (Ascent, 2026-08-10). The verdict below is still honest; it is just STRICTER than it
    ...
    private function __collect_git_dirty_paths(string $base_dir): ?array
    {
        ...
        //
        // That is the deadlock seen on a live box (Ascent, 2026-08-10): a committed edit to a

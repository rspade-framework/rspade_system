...
class Jqhtml_Router {
    ...
    static async dispatch(url, options = {}) {
        ...
        // Debug logging
        if (route_info) {
            core.logDispatch(url, route_info, route_info.args, false);
        }
        if (!route_info) {
        ...
        try {
            ...
            if (!layout_component || layout_component.constructor.name !== layout_name) {
                ...
                // Get layout class
                const LayoutClass = core.get_component_class(layout_name);
                if (!LayoutClass) {
 ...
 */
class Jqhtml_Route extends core.Jqhtml_Component {
    constructor(options) {
        super(options);
 ...
 */
class Jqhtml_Layout extends core.Jqhtml_Component {
    constructor(options) {
        super(options);
 ...
 */
class Jqhtml_SPA extends core.Jqhtml_Component {
    constructor() {
        super(...arguments);
...
exports.Jqhtml_Layout = Jqhtml_Layout;
exports.Jqhtml_Route = Jqhtml_Route;
exports.Jqhtml_Router = Jqhtml_Router;
exports.Jqhtml_SPA = Jqhtml_SPA;

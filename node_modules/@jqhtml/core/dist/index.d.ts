...
export { render_template, escape_html, escape_html_nl2br } from './template-renderer.js';
...
export declare function init(jQuery?: any, config?: Jqhtml_Config): void;
...
import { render_template, escape_html, escape_html_nl2br } from './template-renderer.js';
...
declare const jqhtml: {
    ...
    escape_html_nl2br: typeof escape_html_nl2br;
    __version: string;
    tombstone: string;
    configure: typeof configure;
    get_config: typeof get_config;
    add_object_printer: typeof add_object_printer;
    print_object: typeof print_object;
    dynamic_component_name: typeof dynamic_component_name;
    debug_overlay: {
        enable(): boolean;
        disable(): void;
        is_enabled(): boolean;

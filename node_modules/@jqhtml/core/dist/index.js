    ...
    _render(id = null, options = {}) {
        ...
        if (template_def && template_def.render) {
            ...
            const jqhtml = {
                ...
                // Objects reaching <%= %> / <%!= %> / <%br= %> - see value-printers.ts
                print_object,
                // <{expression}> name validation - see component-name.ts

 ...
 */
export declare const render_utilities: {
...
export declare class Jqhtml_Component {
    ...
    static template?: any;
    static readonly COMPONENT_NAME_PATTERN: RegExp;
    $: any;
